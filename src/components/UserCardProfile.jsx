...
import { Card, CardContent, Typography, Avatar, useTheme, IconButton } from '@mui/material';
...
const UserCardProfile = () => {
    ...
    const {pressedFollow, setPressedFollow, loadingFollow, setLoadingFollow, setUsertoFollow, allPosts} = useContext(AppStatesContext); 
