...
export default function SubmitPostFormNavbar({currentUser, handleClose}) {


    const { snackbarOpenCondition, setSnackbarOpenCondition, snackbarOpen, setSnackbarOpen, imgSubmittedNavbar, setImgSubmittedNavbar, pressedSubmitPostNavbar, setPressedSubmitPostNavbar, isSubmittingPost, setisSubmittingPost } = useContext(AppStatesContext); 
  ...
  // Submit the post directly when submitting the navbar form
  async function handleSubmitNavbar(event) {
    ...
    try {
      ...
      setPressedSubmitPostNavbar(!pressedSubmitPostNavbar)
      handleClose()
    }
  }
  ...
  return (
    <>
        <form onSubmit={handleSubmitNavbar}>
          <label>
            Send a Post:
        ...
        <FileInputPopover
            ...
            imgSubmitted={imgSubmittedNavbar}
